    ...
    <>
      <section className="relative flex flex-col space-y-4 items-center mt-10 sm:mt-20 xl:px-32 bg-white">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="text-[14px] sm:text-[16px] xl:text-[18px] text-center font-monosans text-black font-extralight w-10/12 md:w-8/12 xl:w-8/12 my-3 sm:my-4 lg:my-5 xl:my-6">
            {TechDescription}
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-3 py-3 w-[100%]">
          {GenAi?.slice(0, 5).map((menu, index) => (
            <div
              data-aos="fade-up"
              key={index}
              className="flex gap-3 justify-center items-center text-black px-4 py-2 rounded-full border-2 border-black bg-gradient-to-r from-[#ffffff] via-[#ffffff] to-transparent"
            >
              <img
                src={menu.icon}
                alt={menu.title}
