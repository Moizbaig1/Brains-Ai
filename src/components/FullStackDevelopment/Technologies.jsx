...
import { FullStackTechnologies, TechDescription } from "../Data/FullStack";
  ...
  return (
    <>
      <section className="relative flex flex-col space-y-4 items-center mt-10 sm:mt-20 xl:px-32 bg-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 py-3 px-5 w-full">
          {FullStackTechnologies?.map((menu, index) => (
            <div
              data-aos="fade-up"
              key={index}
