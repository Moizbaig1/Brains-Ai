...
import { FullStackSubServices, ServiceDescription } from "../Data/FullStack";
    ...
    <>
      <section className="relative flex flex-col space-y-4 items-center mt-10 lg:px-10 bg-white">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p
            data-aos="fade-down"
            className="text-[14px] sm:text-[16px] xl:text-[18px] text-center font-monosans font-extralight w-10/12 md:w-8/12 xl:w-8/12 my-3 sm:my-4 lg:my-5 xl:my-6"
            style={{
              color: "black", // Set text color to black
            }}
          >
        ...
        <div className="flex flex-wrap justify-center py-5 px-5 lg:px-0">
          {FullStackSubServices.map((offer, index) => (
            <div
              key={index}
              data-aos="fade-up"
