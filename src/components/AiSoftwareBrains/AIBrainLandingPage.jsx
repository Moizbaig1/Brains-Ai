  ...
  return (
    <div className='max-w-3xl mx-auto p-6 bg-black rounded-lg shadow-lg mt-10 mb-10'>
      <header className='text-center mb-6'>
        ...
        <p className='text-lg text-gray-300 italic'>Your Autonomous Development Assistant</p>
      </header>

      <section className='mb-6'>
        <h2 className='text-3xl font-semibold text-white mb-4'>Service Description</h2>
      ...
      <section>
        <h2 className='text-3xl font-semibold text-white mb-4'>Available Package</h2>
        <div className='bg-gray-800 p-6 rounded-lg shadow-md transition-transform transform hover:scale-105'>
          ...
          <p className='text-lg text-gray-300'>Price: <span className='font-bold text-green-400'>$5,000/month</span></p>
          <p className='text-gray-300 mb-2'>Includes all the features mentioned above. The bot handles the entire project lifecycle, from initial instructions to final delivery, with minimal human intervention.</p>
          <p className='text-gray-300'><strong>Demo:</strong> Available upon request (waiting list due to high demand).</p>
        </div>
      </section>
    </div>
  );
