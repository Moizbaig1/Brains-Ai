...
// Import images directly from the file system
    ...
    <>
      ...
      <section className="relative snap-center flex flex-col space-y-4 items-center my-16">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p
            data-aos="fade-up"
            className="text-[14px] sm:text-[16px] xl:text-[18px] text-center font-monosans text-white font-extralight w-10/12 md:w-[60%] xl:w-[65%]"
          >
            Visit our domain where state-of-the-art technology meets to create
            inventive solutions in CMS, Web 3.0, Gen AI, and more.
          </p>
        </div>
